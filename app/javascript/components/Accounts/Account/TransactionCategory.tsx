...
export const TransactionCategory: React.FC<Props> = ({ editing, transaction }) => {
    ...
    if (editing.current !== transaction) {
        return <Button fullWidth textAlign="start" variant="tertiary" onClick={selectMe}>{transaction.categoryId}</Button>;
    }
